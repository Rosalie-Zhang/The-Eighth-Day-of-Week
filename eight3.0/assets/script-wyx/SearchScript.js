...
cc.Class({
    ...
    on_btn_onclick_laptop:function(){
        this.node.active = true;
    ...
    on_btn_onclick_window2:function(){
        this.node.active = true;
    ...
    on_btn_onclick_window:function(){
        this.Textindex = 0;
        this.node.active = true;
        var str = "窗户半开着。";
        this.node.getChildByName("TextLabel").getComponent(cc.Label).string = "";
